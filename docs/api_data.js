define({ "api": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example Usage (requires the authorisation token header):",
        "content": "curl -H \"Content-Type: application/json\" -X POST -d '{\"name\":\"DH001\",\"place\":\"lower mountain top\"}'   https://io.imago.live/integrate/2/attributes?id=e1865861-0d53-4d49-a554-af79dae9aa81&group=custom&type=custom",
        "type": "curl"
      }
    ],
    "header": {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>Data identifier. Only an Imagery ID is permitted at this time.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            ...
            "description": "<p>Describes where the attributes should be stored. Only imagery attributes are supported.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            ...
            "field": "group",
            "defaultValue": "custom",
            "description": "<p>Specifies which group of attributes to assign. Only custom imagery attributes are permitted currently.</p>"
          }
        ]
      },
      "examples": [
